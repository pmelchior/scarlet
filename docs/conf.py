...
latex_documents = [
    (master_doc, 'scarlet.tex', 'scarlet Documentation',
     'Fred Moolekamp and Peter Melchior', 'manual'),
]
...
man_pages = [
    (master_doc, 'scarlet', 'scarlet Documentation',
     [author], 1)
]
